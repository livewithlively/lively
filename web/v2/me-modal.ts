...
import { THEME_ORDER, setThemePref, themePref, type ThemePref } from '../theme.js';
...
type SecKey = 'profile' | 'ai' | 'notify' | 'look' | 'account';
...
function accountPane(data: any, logins: any, close: () => void): HTMLElement {
  ...
  kids.push(el('div', { class: 'v2me-more-k', text: '더 자세한 설정' }),
    moreLink('#/system/me-ai', '내 AI 계정', '내 세션이 어떤 AI 계정으로 실행되는지 보고 로그인합니다.', close),
    moreLink('#/system/me-logins', '외부 서비스 관리', '슬랙·노션 같은 서비스를 내 계정으로 잇습니다.', close),
