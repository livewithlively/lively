...
//  아무 앱에나 주면 그 뜻이 닳는다.
const TILE_COLORS: Record<AppDef['icon'], [string, string]> = {
...
const TILE_SOLID: Partial<Record<AppDef['icon'], string>> = {
...
export function appTileIcon(icon: AppDef['icon'], cls?: string): SVGElement {
  const n = ++tileSeq;
