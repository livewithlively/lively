...
import { anchoredPopover, api, apiUrl, el, personFace, toast, TOKEN_KEY, wsKey } from '../core.js';
...
const LAYOUT_KEY = wsKey('lively_panes_layout_v2');   // #1875 — projectId 로 키를 잡으므로 워크스페이스별    // { last: Layout, p: { [projectId]: Layout } }
