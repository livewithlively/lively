...
export function renderSession(host: HTMLElement, data: V2Data, id: string, trail?: TrailWidget | null, onPickProject?: (anchor: HTMLElement) => void): SessionChatHandle | null {
