...
export function renderSession(host: HTMLElement, data: V2Data, id: string, trail?: TrailWidget | null, onPickProject?: (anchor: HTMLElement) => void, onRename?: (label: string) => Promise<void>): SessionChatHandle | null {
