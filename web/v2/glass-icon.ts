...
const GLASS_ART: Record<string, GlassArt> = {
  ...
  // 분류체계(#4233). 태그 묶음. 뒤 태그(서리)가 오른쪽 위로 비껴 서고 앞 태그(색)가 그 위에 겹친다.
  //  앞이 색인 이유는 세션 이력(sess)과 같다: 뒤가 색이면 색 덩어리가 뒤로 밀려 창백해진다. 구멍은 앞 태그에 흰색으로 뚫는다
  //  (서리 위 흰 구멍은 대비가 안 난다). 형태는 선 글리프 icons.ts tags 와 같은 태그를 2.6배로 키운 것.
  tags: {
    span: [7, 21, 44, 57],
    frost: '<path d="M9.586 5.586A2 2 0 0 0 8.172 5H3a1 1 0 0 0-1 1v5.172a2 2 0 0 0 .586 1.414L8.29 18.29a2.426 2.426 0 0 0 3.42 0l3.58-3.58a2.426 2.426 0 0 0 0-3.42z" transform="translate(18 -4) scale(2.6)"/>',
    color: '<path d="M9.586 5.586A2 2 0 0 0 8.172 5H3a1 1 0 0 0-1 1v5.172a2 2 0 0 0 .586 1.414L8.29 18.29a2.426 2.426 0 0 0 3.42 0l3.58-3.58a2.426 2.426 0 0 0 0-3.42z" transform="translate(2 8) scale(2.6)"/>',
    punch: '<circle cx="18.9" cy="32.7" r="3.4"/>',
    frostFirst: true,
  },
