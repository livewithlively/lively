...
// FIXME(기존 잠재버그·undefined 전역 — 부모가 실수정): domainmapBody 가 참조하는 DM_SEV_*/DM_OP_LABEL 은
//  원본 app.js 어디에도 정의돼 있지 않다(미정의 전역). 분할은 verbatim 보존 — 동작을 지어내지 않고
//  컴파일만 통과하도록 any 스텁만 둔다. 실제 정의는 부모가 별도 처리.
declare const DM_SEV_OF: any;
declare const DM_SEV_RANK: any;
declare const DM_SEV_LABEL: any;
declare const DM_OP_LABEL: any;
