...
const ADMIN_ONLY = ['member-add', 'member-access', 'credentials', 'connectors', 'collector-presets', 'feed-targets', 'project-outbound', 'db-sources', 'storage', 'logs', 'sessions', 'embeddings', 'automation', 'audit', 'ingest-policy', 'session-share', 'visibility-axes'];
