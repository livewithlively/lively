...
function overlayShell(title, content: any[], closeClass: string) {
...
export function confirmDialog(opts: {
  title: string; message?: string; lines?: string[]; note?: string; extra?: any;
  ...
  return new Promise((resolve) => {
    ...
    if (opts.extra) body.append(el('div', { class: 'ov-confirm-extra' }, opts.extra));
