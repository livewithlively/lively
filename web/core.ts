...
//   · 지식(#/knowledge) — 분류축 + 📌 인덱스(핀 전용 뷰) + 통계·검토. 좌 카테고리 사이드바 + 검색/필터 목록.
...
export { $view, applyReveal, el, interleave, reducedMotion, replaceKids, sv } from './lib/dom.js';
...
export { hasScope, markShellSwitch, navOn, setUiModeOverride, state, takeShellSwitch, uiMode, uiModeOverride, visAxisOn } from './lib/state.js';
//  시간·숫자 표기(core 소유분).
