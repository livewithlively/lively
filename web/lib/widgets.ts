...
export function secretInput(attrs?: any): HTMLInputElement {
  const n = el('input', {
    ...(attrs || {}),
...
export function secretRow(input: HTMLInputElement, ...extra: any[]): HTMLElement {
  ...
  btn.addEventListener('click', () => {
    ...
    if (!CSS_MASK_OK) input.type = shown ? 'text' : 'password';   // CSS 가림 미지원 폴백
...
export function markSecretInput(input: HTMLInputElement): void {
...
export function usernameAnchor(): HTMLInputElement {
  return el('input', {
