 ...
 */
const STAGE_TABS: Record<string, Array<{ key: string; label: string; draw: (b: HTMLElement) => Promise<void> }>> = {
  collect: [
...
async function renderStage(stage: string, host: HTMLElement) {
