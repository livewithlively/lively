...
//
// 사용법: node setup/user-uninstall.mjs [--dry-run] [--purge] [--harness claude|codex|opencode|antigravity|all] [--yes]
...
function detect() {
  const out = { claude: false, codex: false, opencode: false, antigravity: false, rc: false };
  const sp = join(HOME, ".claude", "settings.json");
