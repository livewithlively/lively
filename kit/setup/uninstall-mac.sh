...
#
# ▶ 사용법:  bash setup/uninstall-mac.sh [--dry-run] [--purge] [--harness claude|codex|opencode|antigravity|all]
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    -h|--help)
      echo "사용법: bash setup/uninstall-mac.sh [--dry-run] [--purge] [--harness claude|codex|opencode|antigravity|all] [--yes]"
      exit 0 ;;
