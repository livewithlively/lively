...
const GUIDE =
  "[라이블리 — 이 세션의 이름(세션당 1회)]\n" +
  "이 세션은 아직 이름이 임시입니다(첫 지시 앞부분을 자른 것). 지금 이 세션이 **무엇을 하는 자리인지** 드러나는 " +
  "이름을 지어 `session_rename {name: \"…\"}` (lively MCP — session_id 는 생략, 이 세션 자신)로 한 번 등록하세요.\n" +
  ...
  "  · **답변을 막지 마세요** — 지금 받은 지시를 먼저 처리하고, 그 턴 안에서 아무 때나 한 번 부르면 됩니다. " +
