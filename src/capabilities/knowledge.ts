...
import {
  ...
  setKnowledgePropsUi, moveKnowledge, appendBody, isDuplicateAppend,
...
const knowledgeSave: Capability = {
  ...
  handler: async (input: any, user: any, ctx: any) => {
    ...
    const knowledge = await upsertKnowledge(saveInput, writeCtx);
    ...
    return { ...withBody(knowledge), ...seedSyncWarning(knowledge.name) };
  },
};
