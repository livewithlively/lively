// AWS STS 브로커(#746 커넥터 파도2) — 게이트웨이가 '고객사 A 제공 IAM role' 을 sts:AssumeRole 로 가정해
...
//  가정 대상 role ARN·region = vault(org_credential kind=aws_role_arn 의 meta) — 고객사 A가 role·trust 를 세팅하면 등록.
