...
export function buildServer(overrides?: ReadonlyMap<string, boolean>): McpServer {
  ...
  registerMcpCapabilities(server, overrides); // capability: expose.mcp 기본값 + org_tool override(양방향)
  return server;
}
