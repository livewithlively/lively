  ...
  await itemsPool.query(`
    ...
    DO $$ BEGIN
      ...
      ALTER TABLE org_cron ADD CONSTRAINT org_cron_action_chk
        CHECK (action IN ('refresh_all','refresh_repo','refresh_bases','connector_sync','connector_push','wiki_push','eval_domain_debt','map_unmapped','classify_knowledge','bootstrap_is','distill_sources','agent_inject','agent_headless','ensure_managed_sessions','wikilink_sweep','preview_reconcile'));
    END $$;
