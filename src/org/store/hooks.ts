...
// ════════ 커스텀 훅 — org_hook ════════
// #1689 — opencode(#1519 때 누락)·antigravity 보강. delivery/shared.ts HOOK_HARNESSES 와 일치 유지.
export type HookHarness = "claude" | "codex" | "openclaw" | "opencode" | "antigravity" | "all";
