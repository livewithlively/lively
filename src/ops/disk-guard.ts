...
//
// 임계치는 관리탭 저장소 정책이 단일 출처(src/org/policies/storage-policy.ts) — 고객 박스는 .env 를 못 고친다.
...
// 남은 stopDiskWatch/startDiskWatch 는 없다: src/ops/box-watch.ts 의 startBoxWatch 를 쓴다.
