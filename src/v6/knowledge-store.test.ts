// knowledge-store 순수함수 단위 체크(resolveUpsertFacets · appendBody) — DB 불요. 테스트 러너 없이 node:assert 로 자급.
...
import { resolveUpsertFacets, appendBody, isDuplicateAppend } from "./knowledge-store.js";
