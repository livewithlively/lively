...
//  실행: npm run build && node dist/project-origin.test.js
...
function main(): void {
  ...
  {
    assert.equal(originKey("git@git.honestfund.kr:hf-dev/backend/honest-one.git"), "git.honestfund.kr/hf-dev/backend/honest-one");
    assert.equal(originKey("https://git.honestfund.kr/hf-dev/backend/honest-one.git"), "git.honestfund.kr/hf-dev/backend/honest-one");
