...
async function renderCategories(view) {
    ...
    try {
        ...
        view.replaceChildren(pageHead('분류체계', null, [], '분류체계'), errorNote(e, '분류체계를 불러오지 못했습니다'));
        return;
    }
    ...
    const head = pageHead('분류체계', '지식과 프로젝트를 어떤 갈래로 나눌지 정합니다. 정의가 오래되면 여기서 먼저 드러납니다.', [], '분류체계');
