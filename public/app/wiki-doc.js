...
async function buildWikiDoc(container, name, opts = {}) {
    ...
    crumbs.append(el('span', { class: 'wk-crumb-sep', 'aria-hidden': 'true', text: '›' }), el('span', { class: 'wk-crumb wk-crumb-cur', text: k.title || k.name }));
...
function openWikiSearch() {
    ...
    function paint() {
        ...
        list.replaceChildren(...entries.map((e, i) => {
            ...
            const row = el('button', { class: 'qk-row' + (i === sel ? ' on' : ''), type: 'button' }, wkTick(e), el('span', { class: 'qk-row-ic', text: knPageIcon(e) }), el('div', { class: 'qk-row-main' }, el('div', { class: 'qk-row-title', text: e.title || e.name }), snip ? el('div', { class: 'qk-row-snip', text: snip }) : null));
