...
function previewCard(p, reload) {
    ...
    const face = el('span', { class: 'pvg-face' }, el('i', { class: 'pvg-sk w1', 'aria-hidden': 'true' }), el('i', { class: 'pvg-sk w2', 'aria-hidden': 'true' }), el('i', { class: 'pvg-sk w3', 'aria-hidden': 'true' }), state);
