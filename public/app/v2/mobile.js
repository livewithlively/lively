...
export function mountMobileChrome(root, side, aside) {
    ...
    sv('svg', { viewBox: '0 0 24 24', class: 'v2-mbar-ic v2-mbar-ic--m', 'aria-hidden': 'true' }, sv('path', { d: 'M4 7h16M4 12h16M4 17h16' })), sv('svg', { viewBox: '0 0 24 24', class: 'v2-mbar-ic v2-mbar-ic--w', 'aria-hidden': 'true' }, sv('path', { d: ICONS.panel })));
