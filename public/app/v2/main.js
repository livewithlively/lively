...
function drawAsideLiv() {
    ...
    asideEl.replaceChildren(el('div', { class: 'v2-aside-h' }, el('b', { text: '리브가 지금 보는 것' }), el('span', { class: 'v2-k', text: '손볼 것' })), rail, el('p', { class: 'v2-fine', text: '리브가 던진 물음은 대화 입력 바로 위에 뜹니다.' }));
    return rail;
}
