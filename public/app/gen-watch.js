...
function ownGen() {
    ...
    if (fromModule)
        return fromModule;
    const entry = document.querySelector('script[type="module"][src*="?v="]');
...
let armed = false;
export function watchStaleShell() {
    if (!MY_GEN || armed)
        return;
    armed = true;
