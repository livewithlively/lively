...
function infoPop(text, m) {
    ...
    btn.addEventListener('click', () => {
        ...
        pop = el('div', { class: 'hint-pop', role: 'dialog' }, text ? el('p', { class: 'hint-pop-text' }, ...inlineBold(text)) : null, m ? meaningBody(m) : null);
...
function sectionTitle(titleText, m, hint) {
    ...
    return el('div', { class: 'section-title' }, el('h2', { text: titleText }), infoPop(hint || (isText ? m : null), isText ? null : m));
}
