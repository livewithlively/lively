...
function wkOriginParts(e) {
    if (!e)
        return { who: '', how: '' };
    if (e.provenance === 'observed')
        return { who: WK_MIRROR_LABEL[e.external_system] || '외부 미러', how: '' };
...
export { wkAurora, wkDayLabel, wkDeck, wkDocCard, wkEmpty, wkHash, wkIsRead, wkMarkRead, wkMetaOf, wkOriginText, wkOriginTitle, wkReadVisits, wkRecordVisit, wkRow, wkSection, wkStamp, wkTick, wkTypeTag, };
