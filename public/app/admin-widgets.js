...
const psBlock = (title, hint, ctrl) => el('section', { class: 'ps-block' }, el('h3', { class: 'ps-block-title', text: title }), hint ? el('p', { class: 'ps-block-hint' }, ...uiText(hint)) : null, ctrl);
...
export { allowlistCard, fmtBytes, fmtElapsed, mcpFieldsEl, psBlock, psInputStyle, sectionHead, sectionTitle, segTabs, targetMembersField, };
