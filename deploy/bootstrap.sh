...
# ─────────────────────────────────────────────────────────────────────────────
APP_DIR="${LIVELY_APP_DIR:-$HOME/lively}"
GIT_URL="${LIVELY_GIT_URL:-https://github.com/livewithlively/lively.git}"
...
REPO_SLUG="${LIVELY_REPO:-livewithlively/lively}"
ASSET_NAME="${LIVELY_ASSET:-lively.tgz}"
